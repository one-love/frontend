...
import actions from '../../actions/application/remove';
...
const ApplicationRemove = React.createClass({
  propTypes: {
...
export default connect(mapStateToProps, actions)(ApplicationRemove);
