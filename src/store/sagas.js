...
import { PROVIDER_LIST } from 'components/organisms/provider-list/actions'
...
import providerListSaga from 'components/organisms/provider-list/sagas'
...
export default function* greenSaga() {
  ...
  yield takeLatest(PROVIDER_LIST, providerListSaga)
